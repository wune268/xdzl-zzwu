...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/resource/css/animate.min.css">
    <script src="<?php bloginfo('template_url'); ?>/resource/js/wow.js" type="text/javascript"></script>
    <script>
        new WOW().init();
    </script>
    <script src="<?php bloginfo('template_url'); ?>/resource/js/jquery.min.js" type="text/javascript"></script>
    <script src="<?php bloginfo('template_url'); ?>/resource/js/jquery.SuperSlide.js" type="text/javascript"></script>
